# Prompt 3 — finalized research scope

Candidate title: Free and gap-constrained annealing of FFF-printed PLA: a thermo-mechanical computational study

This record is governed by PROJECT_STATE.md. Model implementation and numerical evidence remain unestablished.

### 2. Research question and finalized scope

Primary research question. For a specified FFF-PLA grade, print architecture and geometry, how do annealing temperature, holding time and initial fixture clearance influence transient thermal exposure and the irreversible dimensional change, warpage and residual stress evaluated after cooling and fixture release, relative to free annealing within an evidence-supported sub-melting domain?
...
Scope finalized under the user’s Prompt 3 instruction; no advance to Prompt 4.
